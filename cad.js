...
function extrudeValidSel(cmd) {
  ...
  // extrudesrf: 서피스(벽 면) 또는 평면 곡선/원 (면에서 돌출) — 폴리라인은 closed 무관 3점 이상
  return sel.filter(e => (e.bim && e.bim.kind === 'wall') || (!e.bim && ((e.type === 'LWPOLYLINE' && (e.points || []).length >= 3) || e.type === 'CIRCLE')));
}
